...
public final class SsoServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<sso.Api.LoginInfoReq,
      sso.Api.LoginInfoRsp> getGetLoginInfoMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "GetLoginInfo",
      requestType = sso.Api.LoginInfoReq.class,
      responseType = sso.Api.LoginInfoRsp.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<sso.Api.LoginInfoReq,
      sso.Api.LoginInfoRsp> getGetLoginInfoMethod() {
    io.grpc.MethodDescriptor<sso.Api.LoginInfoReq, sso.Api.LoginInfoRsp> getGetLoginInfoMethod;
      ...
      synchronized (SsoServiceGrpc.class) {
        if ((getGetLoginInfoMethod = SsoServiceGrpc.getGetLoginInfoMethod) == null) {
          SsoServiceGrpc.getGetLoginInfoMethod = getGetLoginInfoMethod = 
              io.grpc.MethodDescriptor.<sso.Api.LoginInfoReq, sso.Api.LoginInfoRsp>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(
                  "sso.SsoService", "GetLoginInfo"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.lite.ProtoLiteUtils.marshaller(
                  sso.Api.LoginInfoReq.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.lite.ProtoLiteUtils.marshaller(
                  sso.Api.LoginInfoRsp.getDefaultInstance()))
                  .build();
          }
        }
     }
  ...
  private static volatile io.grpc.MethodDescriptor<sso.Api.User,
      sso.Api.User> getSaveUserInfoMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "SaveUserInfo",
      requestType = sso.Api.User.class,
      responseType = sso.Api.User.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<sso.Api.User,
      sso.Api.User> getSaveUserInfoMethod() {
    io.grpc.MethodDescriptor<sso.Api.User, sso.Api.User> getSaveUserInfoMethod;
      ...
      synchronized (SsoServiceGrpc.class) {
        if ((getSaveUserInfoMethod = SsoServiceGrpc.getSaveUserInfoMethod) == null) {
          SsoServiceGrpc.getSaveUserInfoMethod = getSaveUserInfoMethod = 
              io.grpc.MethodDescriptor.<sso.Api.User, sso.Api.User>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(
                  "sso.SsoService", "SaveUserInfo"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.lite.ProtoLiteUtils.marshaller(
                  sso.Api.User.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.lite.ProtoLiteUtils.marshaller(
                  sso.Api.User.getDefaultInstance()))
                  .build();
          }
  ...
  public static abstract class SsoServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void getLoginInfo(sso.Api.LoginInfoReq request,
        io.grpc.stub.StreamObserver<sso.Api.LoginInfoRsp> responseObserver) {
      asyncUnimplementedUnaryCall(getGetLoginInfoMethod(), responseObserver);
    }

    /**
     */
    public void saveUserInfo(sso.Api.User request,
        io.grpc.stub.StreamObserver<sso.Api.User> responseObserver) {
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                sso.Api.LoginInfoReq,
                sso.Api.LoginInfoRsp>(
  ...
  public static final class SsoServiceBlockingStub extends io.grpc.stub.AbstractStub<SsoServiceBlockingStub> {
    ...
    /**
     */
    public sso.Api.LoginInfoRsp getLoginInfo(sso.Api.LoginInfoReq request) {
    ...
    /**
     */
    public sso.Api.User saveUserInfo(sso.Api.User request) {
      return blockingUnaryCall(
  ...
  public static final class SsoServiceFutureStub extends io.grpc.stub.AbstractStub<SsoServiceFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<sso.Api.LoginInfoRsp> getLoginInfo(
        sso.Api.LoginInfoReq request) {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<sso.Api.User> saveUserInfo(
        sso.Api.User request) {
      return futureUnaryCall(
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_GET_LOGIN_INFO:
          serviceImpl.getLoginInfo((sso.Api.LoginInfoReq) request,
              (io.grpc.stub.StreamObserver<sso.Api.LoginInfoRsp>) responseObserver);
          break;
        case METHODID_SAVE_USER_INFO:
          serviceImpl.saveUserInfo((sso.Api.User) request,
              (io.grpc.stub.StreamObserver<sso.Api.User>) responseObserver);
          break;
        default:
